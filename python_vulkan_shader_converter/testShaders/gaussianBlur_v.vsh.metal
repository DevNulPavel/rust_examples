...
#define vPxSize uniforms.vPxSize
...
vertex ColorInOut vertFunc(Vertex input [[stage_in]], constant ConstantBuffer& uniforms [[buffer(1)]])
{
    ...
    v_blurTexCoords_0.xy = v_texcoord + vec2(0.0, -vPxSize * 7.0);
    v_blurTexCoords_0.zw = v_texcoord + vec2(0.0, -vPxSize * 6.0);
    v_blurTexCoords_1.xy = v_texcoord + vec2(0.0, -vPxSize * 5.0);
    v_blurTexCoords_1.zw = v_texcoord + vec2(0.0, -vPxSize * 4.0);
    v_blurTexCoords_2.xy = v_texcoord + vec2(0.0, -vPxSize * 3.0);
    v_blurTexCoords_2.zw = v_texcoord + vec2(0.0, -vPxSize * 2.0);
    v_blurTexCoords_3.xy = v_texcoord + vec2(0.0, -vPxSize);
    v_blurTexCoords_3.zw = v_texcoord + vec2(0.0,  vPxSize);
    v_blurTexCoords_4.xy = v_texcoord + vec2(0.0,  vPxSize * 2.0);
    v_blurTexCoords_4.zw = v_texcoord + vec2(0.0,  vPxSize * 3.0);
    v_blurTexCoords_5.xy = v_texcoord + vec2(0.0,  vPxSize * 4.0);
    v_blurTexCoords_5.zw = v_texcoord + vec2(0.0,  vPxSize * 5.0);
    v_blurTexCoords_6.xy = v_texcoord + vec2(0.0,  vPxSize * 6.0);
    v_blurTexCoords_6.zw = v_texcoord + vec2(0.0,  vPxSize * 7.0);
