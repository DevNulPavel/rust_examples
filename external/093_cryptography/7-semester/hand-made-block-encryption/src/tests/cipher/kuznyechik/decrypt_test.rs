...
fn test_decryption() {
    ...
    let input = [0x7f, 0x67, 0x9d, 0x90, 0xbe, 0xbc, 0x24, 0x30, 0x5a, 0x46, 0x8d, 0x42, 0xb9, 0xd4, 0xed, 0xcd];
    ...
    assert_eq!(decrypted_block.len(), 16, "Неверный размер блока текста");
