use crate::{cipher::kuznyechik::cipher::Kuznyechik, tests::cipher::kuznyechik::common::create_test_cipher};
...
fn test_key_generation() {
    ...
    assert_eq!(round_keys.len(), 10, "Неверное количество раундовых ключей");
...
fn test_invalid_key_lenght() {
    ...
    Kuznyechik::new(&invalid_key).unwrap();
}
