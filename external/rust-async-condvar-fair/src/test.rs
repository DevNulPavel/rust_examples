...
struct DebugDisabled;
#[derive(Debug)]
struct DebugEnabled(LineWriter<Eprintln>);

impl DebugWrite for DebugDisabled {
    const ENABLED: bool = false;
}
impl DebugWrite for DebugEnabled {
