...
pub fn pvrgz_to_webp(utils_pathes: &UtilsPathes, target_webp_quality: u8, pvrgz_file_path: &Path, webp_file_path: &Path) -> Result<(), eyre::Error> {
